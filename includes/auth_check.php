...
function require_role($required_role) {
    ...
    $isAuthenticated =
        ($role === 'student' && isset($_SESSION['student_id'])) ||
        ($role === 'employer' && isset($_SESSION['employer_id'])) ||
        ($role === 'admin' && isset($_SESSION['admin_id']));
...
function get_current_session_user() {
    ...
    } elseif ($role === 'employer' && isset($_SESSION['employer_id'])) {
